...
public class PAMTask extends RSXMultipleImageSelectionSurveyTask {
    ...
    public static PAMTask create(String identifier, RSXAssessment assessment) {
        ...
        if (assessment.getItems().isEmpty()) {
            ...
            PAMStep pamStep = new PAMStep(assessment.getIdentifier(), assessment.getPrompt(), answerFormat, PAMTask.defaultOptions());
        ...
        return new PAMTask(identifier, PAMTask.defaultOptions(), steps);
    }
    ...
    public static PAMTask create(String identifier, String propertiesFileName, Context context) {
        ...
        return PAMTask.create(identifier, assessment);
